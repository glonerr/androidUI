...
public final class Bitmap implements Parcelable {
    ...
    */
    ...
    public final int getWidth() {
        return mWidth == -1 ? mWidth = /*nativeWidth(mNativeBitmap)*/mImage.getBounds().width : mWidth;
    }

    /** Returns the bitmap's height */
    public final int getHeight() {
        return mHeight == -1 ? mHeight = /*nativeHeight(mNativeBitmap) */mImage.getBounds().height: mHeight;
    }
