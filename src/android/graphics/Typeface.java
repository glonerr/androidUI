...
public class Typeface {
    ...
    public static Typeface create(String familyName, int style) {
    	Typeface typeface =  new Typeface(nativeCreate(familyName, style));
    	int swtStyle = 0;
    	switch (style) {
    	...
    	if(familyName == null){
    		typeface.mFontData = new FontData();
    		typeface.mFontData.setStyle(swtStyle);
    	}else{
    		typeface.mFontData = new FontData(familyName,10,swtStyle);
    	}
        return  typeface;
    }
    ...
    FontData mFontData;
    private static int native_instanceimpl;
}