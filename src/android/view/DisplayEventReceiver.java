...
public abstract class DisplayEventReceiver {
    ...
    private static int nativeInit(DisplayEventReceiver receiver,
            MessageQueue messageQueue){
    	return ++nativeInit;
    }
    private static int nativeInit;
    private static native void nativeDispose(int receiverPtr);
    private static void nativeScheduleVsync(int receiverPtr){}
    ...
    public void scheduleVsync() {
        if (mReceiverPtr == 0) {
        	...
        	onVsync(System.nanoTime(), Surface.BUILT_IN_DISPLAY_ID_MAIN, mFrame++);
