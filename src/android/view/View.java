...
public class View implements Drawable.Callback, KeyEvent.Callback,
	 ...
	 * layouts. 设置为true,apps将绘制布局的debug信息
	 * 
	 * @hide
	 */
	...
	/**
	 * Used to mark a View that has no ID. 表示view没有ID
	 */
	public static final int NO_ID = -1;

	/**
	 * This view does not want keystrokes. Use with TAKES_FOCUS_MASK when
	 * calling setFlags. 表示不能获得焦点
	 */
	 ...
	 * 表示view会调整padding适应系统窗口
	 */
	private static final int FITS_SYSTEM_WINDOWS = 0x00000002;

	/**
	 * This view is visible. Use with {@link #setVisibility} and <a
	 * href="#attr_android:visibility">{@code android:visibility}. view可见
	 */
	 ...
	 * {@code android:visibility}. view不可见布局时占空间
	 */
	 ...
	 * ENABLED_MASK when calling setFlags. {@hide} 有效的
	 */
	static final int ENABLED = 0x00000000;

	/**
	 * This view is disabled. Interpretation varies by subclass. Use with
	 * ENABLED_MASK when calling setFlags. {@hide} 失效的
	 */
	static final int DISABLED = 0x00000020;

	/**
	 * Mask for use with setFlags indicating bits used for indicating whether
	 * this view is enabled {@hide} 是否有效的掩码
	 */
	 ...
	 * {@hide} 绘制时不调用{@link #onDraw(android.graphics.Canvas)}
	 */
	static final int WILL_NOT_DRAW = 0x00000080;

	/**
	 * Mask for use with setFlags indicating bits used for indicating whether
	 * this view is will draw {@hide} 是否绘制的掩码
	 */
	 ...
	 * security feature. {@hide} 当window obscured过滤触摸事件
	 */
	 ...
	 * <p>
	 * {@hide} 可点击,view会调用OnClickListener
	 */
	 ...
	 * context menu.
	 * </p>
	 * {@hide} 长按时view调动OnLongClickListener或显示上下文菜单
	 */
	 ...
	 * translucency on the view's content. 滚动条绘制在content area中不增加padding.滚动条半透明
	 */
	 ...
	 * content area of the view. 滚动条绘制在padding area中增加padding
	 */
	 ...
	 * without increasing the padding. The scrollbars will be overlaid with
	 * translucency. 滚动条绘制在view中不增加padding.滚动条半透明
	 */
	 ...
	 * background, if any. 滚动条绘制在view中增加padding
	 */
	...
	/**
	 * Mask for scrollbar style. {@hide} 滚动条样式的掩码
	 */
	 ...
	 * for events such as clicking and touching. 当点击或者触摸是有声效
	 */
	public static final int SOUND_EFFECTS_ENABLED = 0x08000000;

	/**
	 * View flag indicating whether this view should have haptic feedback
	 * enabled for events such as long presses. 长按事件产生时有反馈
	 */
	 ...
	 * mode. 表示{@link #addFocusables(ArrayList, int, int)}
	 * 要添加可获得焦点的view不论他们在触摸模式下是否可获得焦点
	 */
	public static final int FOCUSABLES_ALL = 0x00000000;

	/**
	 * View flag indicating whether {@link #addFocusables(ArrayList, int, int)}
	 * should add only Views focusable in touch mode. 表示
	 * {@link #addFocusables(ArrayList, int, int)}只添加在触摸模式下可获得焦点的view.
	 */
	 ...
	 * item. 通过{@link #focusSearch(int)}将焦点移到上一个可选择的view
	 */
	public static final int FOCUS_BACKWARD = 0x00000001;

	/**
	 * Use with {@link #focusSearch(int)}. Move focus to the next selectable
	 * item. 通过{@link #focusSearch(int)}将焦点移到下一个可选择的view
	 */
	public static final int FOCUS_FORWARD = 0x00000002;

	/**
	 * Use with {@link #focusSearch(int)}. Move focus to the left. 通过
	 * {@link #focusSearch(int)}将焦点移到左边可选择的view
	 */
	public static final int FOCUS_LEFT = 0x00000011;

	/**
	 * Use with {@link #focusSearch(int)}. Move focus up. 通过
	 * {@link #focusSearch(int)}将焦点移到上边可选择的view
	 */
	public static final int FOCUS_UP = 0x00000021;

	/**
	 * Use with {@link #focusSearch(int)}. Move focus to the right. 通过
	 * {@link #focusSearch(int)}将焦点移到右边可选择的view
	 */
	public static final int FOCUS_RIGHT = 0x00000042;

	/**
	 * Use with {@link #focusSearch(int)}. Move focus down. 通过
	 * {@link #focusSearch(int)}将焦点移到下边可选择的view
	 */
	 ...
	 * @hide
	 */
	public static final int ACCESSIBILITY_FOCUS_LEFT = FOCUS_LEFT
			| FOCUS_ACCESSIBILITY;
	 ...
	 * @hide
	 */
	public static final int ACCESSIBILITY_FOCUS_UP = FOCUS_UP
			| FOCUS_ACCESSIBILITY;
	 ...
	 * @hide
	 */
	public static final int ACCESSIBILITY_FOCUS_RIGHT = FOCUS_RIGHT
			| FOCUS_ACCESSIBILITY;
	 ...
	 * @hide
	 */
	public static final int ACCESSIBILITY_FOCUS_DOWN = FOCUS_DOWN
			| FOCUS_ACCESSIBILITY;
	 ...
	 * @hide
	 */
	public static final int ACCESSIBILITY_FOCUS_FORWARD = FOCUS_FORWARD
			| FOCUS_ACCESSIBILITY;
	 ...
	 * @hide
	 */
	public static final int ACCESSIBILITY_FOCUS_BACKWARD = FOCUS_BACKWARD
			| FOCUS_ACCESSIBILITY;
	 ...
	 * view depending on its state. 表示view没有状态
	 * 
	 ...
	 * {@link android.graphics.drawable.Drawable} to change the drawing of the
	 * view depending on its state. 表示view有效状态
	 * 
	 * @see android.graphics.drawable.Drawable
	 * @see #getDrawableState()
	 */
	 ...
	 * {@link android.graphics.drawable.Drawable} to change the drawing of the
	 * view depending on its state.表示view获得焦点状态
	 * 
	 * @see android.graphics.drawable.Drawable
	 * @see #getDrawableState()
	 */
	 ...
	 * {@link android.graphics.drawable.Drawable} to change the drawing of the
	 * view depending on its state.表示view选中状态
	 * 
	 * @see android.graphics.drawable.Drawable
	 * @see #getDrawableState()
	 */
	 ...
	 * {@link android.graphics.drawable.Drawable} to change the drawing of the
	 * view depending on its state.表示view按压状态
	 * 
	 * @see android.graphics.drawable.Drawable
	 * @see #getDrawableState()
	 * @hide
	 ...
	 * {@link android.graphics.drawable.Drawable} to change the drawing of the
	 * view depending on its state.表示view所在的窗口获得焦点状态
	 * 
	 * @see android.graphics.drawable.Drawable
	 * @see #getDrawableState()
	 */
	...
	// Doubles
	/**
	 * Indicates the view is enabled and has the focus. 表示view是有效并获得焦点
	 * 
	...
	/**
	 * Indicates the view is enabled and selected. 表示view有效并选中
	 * 
	 * @see #ENABLED_STATE_SET
	...
	/**
	 * Indicates the view is focused and selected. 表示view获得焦点并选中
	 * 
	 * @see #FOCUSED_STATE_SET
	 * @see #SELECTED_STATE_SET
	 */
	...
	// Triples
	/**
	 * Indicates the view is enabled, focused and selected. 表示view有效且获得焦点且选中
	 * 
	 * @see #ENABLED_STATE_SET
	 * @see #FOCUSED_STATE_SET
	 * @see #SELECTED_STATE_SET
	 ...
	 * focus. 表示view有效且获得焦点且所在窗口获得焦点且选中
	 * 
	 * @see #ENABLED_STATE_SET
	 * @see #FOCUSED_STATE_SET
	 * @see #SELECTED_STATE_SET
	...
	/**
	 * Indicates the view is pressed and selected. 表示view按压且选中
	 * 
	 * @see #PRESSED_STATE_SET
	 * @see #SELECTED_STATE_SET
	 */
	...
	/**
	 * Indicates the view is pressed and focused. 表示view按压且所获得焦点
	 * 
	 * @see #PRESSED_STATE_SET
	 * @see #FOCUSED_STATE_SET
	 */
	...
	/**
	 * Indicates the view is pressed, focused and selected. 表示view按压且获得焦点且选中
	 * 
	 * @see #PRESSED_STATE_SET
	 * @see #SELECTED_STATE_SET
	 * @see #FOCUSED_STATE_SET
	 ...
	 * focus. 表示view按压且所在窗口获得焦点且选中且获得焦点
	 * 
	 * @see #PRESSED_STATE_SET
	 * @see #FOCUSED_STATE_SET
	 * @see #SELECTED_STATE_SET
	...
	/**
	 * Indicates the view is pressed and enabled. 表示view按压且有效
	 * 
	 * @see #PRESSED_STATE_SET
	 * @see #ENABLED_STATE_SET
	 */
	...
	/**
	 * Indicates the view is pressed, enabled and selected. 表示view按压且有效且选中
	 * 
	 * @see #PRESSED_STATE_SET
	 * @see #ENABLED_STATE_SET
	 * @see #SELECTED_STATE_SET
	...
	/**
	 * Indicates the view is pressed, enabled and focused. 表示view按压且有效且获得焦点
	 * 
	 * @see #PRESSED_STATE_SET
	 * @see #ENABLED_STATE_SET
	 * @see #FOCUSED_STATE_SET
	 ...
	 * focus. 表示view按压且有效且获得焦点且所在窗口获得焦点
	 * 
	 * @see #PRESSED_STATE_SET
	 * @see #ENABLED_STATE_SET
	 * @see #FOCUSED_STATE_SET
	 ...
	 * has the focus. 表示view按压且有效且获得焦点且选中且所在窗口获得焦点
	 * 
	 * @see #PRESSED_STATE_SET
	 * @see #ENABLED_STATE_SET
	 * @see #SELECTED_STATE_SET
	...
	static {
		...
		FOCUSED_WINDOW_FOCUSED_STATE_SET = VIEW_STATE_SETS[VIEW_STATE_WINDOW_FOCUSED
				| VIEW_STATE_FOCUSED];
		FOCUSED_SELECTED_STATE_SET = VIEW_STATE_SETS[VIEW_STATE_SELECTED
				| VIEW_STATE_FOCUSED];
		...
		ENABLED_WINDOW_FOCUSED_STATE_SET = VIEW_STATE_SETS[VIEW_STATE_WINDOW_FOCUSED
				| VIEW_STATE_ENABLED];
		ENABLED_SELECTED_STATE_SET = VIEW_STATE_SETS[VIEW_STATE_SELECTED
				| VIEW_STATE_ENABLED];
		...
		ENABLED_FOCUSED_STATE_SET = VIEW_STATE_SETS[VIEW_STATE_FOCUSED
				| VIEW_STATE_ENABLED];
		...
		PRESSED_WINDOW_FOCUSED_STATE_SET = VIEW_STATE_SETS[VIEW_STATE_WINDOW_FOCUSED
				| VIEW_STATE_PRESSED];
		PRESSED_SELECTED_STATE_SET = VIEW_STATE_SETS[VIEW_STATE_SELECTED
				| VIEW_STATE_PRESSED];
		...
		PRESSED_FOCUSED_STATE_SET = VIEW_STATE_SETS[VIEW_STATE_FOCUSED
				| VIEW_STATE_PRESSED];
		...
		PRESSED_ENABLED_STATE_SET = VIEW_STATE_SETS[VIEW_STATE_ENABLED
				| VIEW_STATE_PRESSED];
		...
		PRESSED_ENABLED_FOCUSED_STATE_SET = VIEW_STATE_SETS[VIEW_STATE_FOCUSED
				| VIEW_STATE_ENABLED | VIEW_STATE_PRESSED];
...
//	    mTouchSlop = ViewConfiguration.get(context).getScaledTouchSlop();
	...
	/**
	 * Set flags controlling behavior of this view. 设置控制view行为的标志位.
	 * 
	 * @param flags
