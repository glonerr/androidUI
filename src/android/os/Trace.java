...
public final class Trace {
    ...
    private static void nativeTraceCounter(long tag, String name, int value){
    	
    }
    private static void nativeTraceBegin(long tag, String name){
    	
    }
    private static void nativeTraceEnd(long tag){
